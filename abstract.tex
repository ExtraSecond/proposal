...
Internet of Things(IoT) devices can suffer from software vulnerabilities in them.
The attacker can then gain access to many of the devices in the same network using the first compromised device if a certain vulnerability is exploited.
...
Another one is to make all devices disappear in public networks, and therefore there is no attack point at all.
